...
my_subscription_id = ENV['AZURE_SUBSCRIPTION_ID'] # your Azure Subscription Id
my_resource_group = 'azurestack-ruby-deployment-sample'            # the resource group for deployment
my_pub_ssh_key_path = File.expand_path('~/id_rsa.pub')   # the path to your rsa public key file
